            ...
            <div style="width: 25%">
                <x-forms.form method="POST" action="/register" enctype="multipart/form-data">
                    ...
                    <input
                        ...
                        label="Employer Logo" name="logo" type="file" aria-describedby="file_input_help"
                        id="file_input" />
                    <div class="text-gray-600 text-sm mb-6">Already have an account? <span><a href="/login"
                                class="text-gray-900 font-semibold hover:text-gray-800 hover:underline">Login</a></span>
                    </div>
